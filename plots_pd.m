...
saveas(figure(gcf), 'S:\Dokumente\Master\NPC_Inverter\plots\PD_PWM_plots.png')
...
set(gcf1, 'position', [300, -100, 800, 800])    
    ...
    % legend('i_a_N')
    title('Strangstrom')
saveas(figure(gcf1), 'S:\Dokumente\Master\NPC_Inverter\plots\PD_xy_I.png')
...
saveas(figure(gcf2), 'S:\Dokumente\Master\NPC_Inverter\plots\PD_xy_U.png')
